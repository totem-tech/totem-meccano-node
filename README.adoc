...
In most cases we expect that you can use one of our binaries to run the software on your operating system or you can compile it using the instructions below.
