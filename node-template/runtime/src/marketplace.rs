...
decl_module! {
    ...
    pub struct Module<T: Trait> for enum Call where origin: T::Origin {
        ...
        pub fn post_listing(origin, p: u32, d: u32) -> Result {
            ...
            <NextId<T>>::put(listing_id.wrapping_add(1));

            // Insert the new listing
            <Listings<T>>::insert(listing_id, listing.clone());
            <Statuses<T>>::insert(listing_id, Status::Active);
        ...
        pub fn buy(origin, listing_id: ListingId) -> Result {
            ...
            ensure!(<Statuses<T>>::get(listing_id) == Status::Active, "Listing already sold");
        ...
        pub fn review(origin, listing_id: ListingId, feedback: FeedbackOf<T>) -> Result {
            ...
            ensure!(<Statuses<T>>::get(listing_id) != Status::Active, "Listing is still active");
